      ...
      <Box sx={{
        ...
        <Box sx={{
          ...
          <Box sx={{
            ...
            ${theme.spacing(5)} -
            ${CULUMN_HEADER_HEIGHT} -
            ${CULUMN_FOOTER_HEIGHT}
            )`,
        ...
        <Box sx={{
          ...
          <Box sx={{
            ...
            <Card sx={{
              ...
              <CardMedia
                sx={{ height: 140 }}
                image='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSmF1XyDmPe-VUumC0giFx7E4nplkMz4AWyRA&s'
                title="green iguana"
              />
              <CardContent sx={{
                p: 1.5, '&:last-child': { p: 1.5 }
