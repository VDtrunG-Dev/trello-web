    ...
    columns: [
      {
        ...
        cardOrderIds: ['card-id-01', 'card-id-06', 'card-id-02', 'card-id-04', 'card-id-05', 'card-id-03', 'card-id-07'],
        cards: [
          {
            _id: 'card-id-01',
            boardId: 'board-id-01',
      ...
      },
      {
        ...
        /**
         * Xử lý bug logic thư viện DND_kit khi column rỗng
         * Phía Fe sẽ tạo ra 1 card đặc biệt: PlaceHolderCard, không liên quan tới BE
